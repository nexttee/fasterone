 ...
 */
function _foxchase_load() {
  $themepath = drupal_get_path('theme', 'foxchase');
 ...
 */
function foxchase_html_head_alter(&$head_elements) {
 ...
 */
function foxchase_breadcrumb($variables) {
 ...
 */
function foxchase_field($variables) {
  $output = '';
 ...
 */
function foxchase_field__taxonomy_term_reference($variables) {
  $output = '';
 ...
 */
function foxchase_links__topbar_main_menu($variables) {
  // We need to fetch the links ourselves because we need the entire tree.
  $links = menu_tree_output(menu_tree_all_data(variable_get('menu_main_links_source', 'main-menu')));
  $output = _foxchase_links($links);
 ...
 */
function foxchase_links__topbar_secondary_menu($variables) {
  // We need to fetch the links ourselves because we need the entire tree.
 ...
 *
 * @see foxchase_links__system_main_menu()
 * @see foxchase_links__system_secondary_menu()
 */
function _foxchase_links($links) {
  $output = '';

  foreach (element_children($links) as $key) {
    $output .= _foxchase_render_link($links[$key]);
  }
 ...
 * @see _foxchase_links()
 */
function _foxchase_render_link($link) {
  $output = '';
  ...
  if (!empty($link['#href'])) {
    ...
    if (!isset($rendered_link)) {
      $rendered_link = theme('foxchase_menu_link', array('link' => $link));
    }
    ...
    if (!empty($link['#below'])) {
      ...
      foreach ($link['#below'] as $sub_link) {
        if (!empty($sub_link['#href'])) {
          $sub_menu .= _foxchase_render_link($sub_link);
        }
      }
 ...
 */
function theme_foxchase_menu_link($variables) {
  $link = $variables['link'];
 ...
 */
function foxchase_preprocess_block(&$variables) {
 ...
 */
function foxchase_preprocess_field(&$variables) {
 ...
 */
function foxchase_preprocess_html(&$variables) {
  global $language;
  ...
  // $font = str_replace(' ', '+', theme_get_setting('foxchase_font'));
  // if (theme_get_setting('foxchase_font')) {
  // drupal_add_css(
 ...
 */
function foxchase_preprocess_node(&$variables) {
 ...
 */
function foxchase_preprocess_page(&$variables) {
  ...
  // Top bar.
  if ($variables['top_bar'] = theme_get_setting('foxchase_top_bar_enable')) {
    $top_bar_classes = array();

    if (theme_get_setting('foxchase_top_bar_grid')) {
      $top_bar_classes[] = 'contain-to-grid';
    }

    if (theme_get_setting('foxchase_top_bar_sticky')) {
    ...
    $variables['top_bar_menu_text'] = check_plain(theme_get_setting('foxchase_top_bar_menu_text'));

    $top_bar_options = array();

    if (!theme_get_setting('foxchase_top_bar_custom_back_text')) {
      $top_bar_options[] = 'custom_back_text:false';
    }

    if ($back_text = check_plain(theme_get_setting('foxchase_top_bar_back_text'))) {
      if ($back_text !== 'Back') {
        $top_bar_options[] = "back_text:'{$back_text}'";
      }
    }

    if (!theme_get_setting('foxchase_top_bar_is_hover')) {
      $top_bar_options[] = 'is_hover:false';
    }

    if (!theme_get_setting('foxchase_top_bar_scrolltop')) {
      $top_bar_options[] = 'scrolltop:false';
    }

    if (theme_get_setting('foxchase_top_bar_mobile_show_parent_link')) {
  ...
  // Messages in modal.
  $variables['foxchase_messages_modal'] = theme_get_setting('foxchase_messages_modal');
  ...
  if (theme_get_setting('foxchase_messages_modal')) {
    drupal_add_js(drupal_get_path('theme', 'foxchase') . '/js/behavior/reveal.js');
  }
}
 ...
 */
function foxchase_css_alter(&$css) {
  // Remove defaults.css file.
  unset($css[drupal_get_path('module', 'system') . '/system.menus.css']);

  // Remove Drupal core CSS.
  if (theme_get_setting('foxchase_disable_core_css')) {
 ...
 */
function foxchase_pager($variables) {
  $tags = $variables['tags'];
  ...
  if ($pager_total[$element] > 1) {
    ...
    if (theme_get_setting('foxchase_pager_center')) {
 ...
 */
function foxchase_theme() {
  $return = array();

  $return['foxchase_reveal'] = array(
    'variables' => array(
    ...
    'function' => 'theme_foxchase_reveal',
  );

  $return['foxchase_menu_link'] = array(
    'variables' => array('link' => NULL),
    'function' => 'theme_foxchase_menu_link',
  );
  return $return;
}
 ...
 *
 * @see theme_foxchase_reveal()
 */
function _foxchase_reveal($reveal = NULL) {
 ...
 *
 * @see foxchase_theme()
 * @see foxchase_preprocess_region()
 * @see _foxchase_reveal()
 */
function theme_foxchase_reveal($variables) {
  // Generate unique IDs.
  static $counter = 0;
 ...
 */
function _foxchase_add_reveals() {
  $markup = '';

  // Retrieve reveal markup from static storage.
  foreach (_foxchase_reveal() as $reveal) {
 ...
 */
function foxchase_theme_registry_alter(&$theme_registry) {
  ...
  foreach ($entity_info as $entity => $info) {
    if (isset($entity_info[$entity]['fieldable']) && $entity_info[$entity]['fieldable']) {
      ...
      if (isset($theme_registry[$entity])) {
        $theme_registry[$entity]['preprocess functions'][] = 'foxchase_entity_variables';
      }
    }
  }
  ...
  if (isset($theme_registry['file_entity'])) {
    $theme_registry['file_entity']['preprocess functions'][] = 'foxchase_entity_variables';
  }
 ...
 *
 * @see foxchase_theme_registry_alter()
 */
function foxchase_entity_variables(&$vars) {
 ...
 */
function foxchase_process_html_tag(&$vars) {
  if (theme_get_setting('foxchase_html_tags')) {
    $el = &$vars['element'];
 ...
 *   An array of links
 */
function foxchase_links__magic_button($variables) {
  ...
  if (count($variables['links']) > 1) {
    switch ($variables['type']) {
      case 'split':
        return foxchase_links__split_button($variables);

      case 'dropdown':

      default:
        return foxchase_links__dropdown_button($variables);
    }
  }
 ...
 */
function foxchase_links__dropdown_button($variables) {
  if (empty($variables['attributes']['class'])) {
    $variables['attributes']['class'] = array();
  }
  ...
  $output = _foxchase_links($variables['links']);
 ...
 */
function foxchase_links__split_button($variables) {
  $links = $variables['links'];
